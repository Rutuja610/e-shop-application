...
export const fetchAllAddresses = (accessToken) => {
	...
	/**
	 * A reference to a function that will reject a promise.
	 * This variable is used to store the reject function of a promise,
	 * allowing it to be called from outside the promise's executor function.
	 * 
	 * @type {Function|null}
	 */
